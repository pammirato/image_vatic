...
{
    h.append("<h4>May only work in CHROME</h4>");
    ...
    h.append("<p> <strong> You should label(draw a bounding box) the SAME object in every image </strong> </p>");
...
//    h.append("<p>If you have not completed a task with us before, you may be given 4 training images to make sure you understand the task.</p>"); 
   ...
   h.append("<h2>Object of Interest Image</h2>");


    h.append("<img src='images/ref_img.jpg' align='right'height='250' width='250'>");
    h.append("<p>The first image you see will have a box aroung one object, the object of interest. For all other images you are to find <strong> this specific object</strong>, and annotate it with a bounding box(You should label this image too).</p>"); 


    h.append("<p><strong> All images are in the same room/home. So take advantage of the first image to give context about where the object is in the scene.</strong> The object will be small in many of the images, so using context will be important.</p>"); 
  ...
  //  h.append("<p> Position your cursor over the view screen to click on the corner of the object of interest. Use the cross hairs to line up your click. Click on another corner to finish drawing the box. The rectangle should tightly and completely enclose the object you are annotating. Resize the box, if necessary, by dragging the edges of the box.</p>");
    ...
    h.append("<p> For each image, click the top left and bottom right points of the object. The rectangle should tightly and completely enclose the object. Resize the box, if necessary, by dragging the edges of the box or using the <strong> keyboard shortcuts </strong>.</p>");


//    h.append("<img src='images/pringles_bbq_gtbox_labelon.png' align='right'heigth='300' width='400'>");
   // h.append("<img src='pringles_bbq_gtbox_labeloff.jpg'align='right'heigth='300' width='400'>");


//   h.append("<h3> Finding the Object</h3>");
//   h.append("<p> <strong> Use the first image!! </strong> </p>");
//   h.append("<p> If you are having trouble finding the object, we provide a red dot near the object to help you find it. Note that the <strong> dot may not be on the object, or may be on a different object, but you should still only annotate the object of interest from the first image</strong>. The dots are simply a guideline to help you find the object. </p>");

//  h.append("<p> EXAMPLE:  </p>");
//  h.append("<p> suppose you are given the following first image, and then later another image, I. </p>");

 //   h.append("<table><tr><td><img src='ref_image_ex.jpg'height='200' width='300'></td><td><img src='I_ex.jpg'height='200' width='300'></td></tr><tr><th>First Image</th><th>Image I</th></tr></table>");


 //   h.append("<p> Even though the dot is on the closest chair, you know from the First Image that the object of interest is the chair on the right. </p>");

  //  h.append("<table><tr><td><img src='images/I_good.jpg'height='200' width='300'></td><td><img src='images/I_bad.jpg'height='200' width='300'></td></tr><tr><th>Good</th><th>Bad</th></tr></table>");
   ...
   */
    ...
    h.append("<img src='images/check_boxes.jpg' align='right'heigth='150' width='200'>");
...
*/
    ...
    h.append("<p>If the ENTIRE object is not in the image, mark the <strong>Outside of view frame</strong> checkbox (this may happen very often or not at all). <br/><br/> Do not worry about the occulsion button. In the next image, remember to uncheck these boxes if the object becomes visible. </p>");
...
//    h.append("<p>When you are ready to submit your work, you may want to double check using the <strong> Previous Image</strong> button. After you have checked your work, press the <strong>Submit HIT</strong> button. We will pay you as soon as possible.</p>");
 ...
 //   h.append("<h3>Label Every Image</h3>")
  ...
  //  h.append("<p> Even though a box may be shown in the image, an annotation will only be recorded if you manually move the box to the correct location. <strong> An annotation is recorded once you see two crossing lines inside the box</strong>.  So annotating one box and just clicking through the rest of the images will not be accepted. </p>"); 


    h.append("<h3>Boxes Are Tight</h3>");
    h.append("<table><tr><td><img src='images/good_pepto.jpg'height='200' width='300'></td><td><img src='images/bad_pepto.jpg'height='200' width='300'></td></tr><tr><th>Good</th><th>Bad</th></tr></table>");
    h.append("<h3>Boxes only contain visible portion of the object</h3>");
    h.append("<table><tr><td><img src='images/good_box.jpg'height='200' width='300'></td><td><img src='images/bad_box.jpg'height='200' width='300'></td></tr><tr><th>Good</th><th>Bad</th></tr></table>");
    h.append("<h3>Boxes contain the entire object</h3>");
    h.append("<table><tr><td><img src='images/good_nature.jpg'height='200' width='300'></td><td><img src='images/bad_nature.jpg'height='200' width='300'></td></tr><tr><th>Good</th><th>Bad</th></tr></table>");
    h.append("<p>The boxes you draw must be tight. They boxes must fit around the object closely.  The annotations on the left would be accepted the ones on the right will be rejected.</p>");

    h.append("<h2>Don't Waste Your Time!</h2>");
    h.append("<img src='images/semi_tight.jpg' align='center'height='200' width='200'>");
    h.append("<p>The box in the image above is tight enough. A small border around the object is okay, but if part of the object is outside the box that is not okay. If you are not sure if the object is in the image, mark it as outside. <strong> Two good mouse clicks should be enough to produce a high quality box in most cases</strong>. </p>");
...
*/
    ...
    h.append("<h2>Out of image vs. in image</h2>");
    ...
    h.append("<img src='images/object_in_frame2.jpg' height='200' width='200'> <img src='images/object_outside_frame2.jpg' height='200' width='200'> <br>");
...
//    h.append("<p>Also displayed on main page</p>");
  //  h.append("<p>These keyboard shortcuts are available for your convenience:(and are printed below each image)</p>");
