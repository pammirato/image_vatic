...
fid_comments = fopen('./comments.txt');

fid_good=fopen('./vids_review_good.txt','wt')
fid_bad=fopen('./vids_review_bad.txt','wt')
fid_nr=fopen('./vids_review_none.txt','wt')
fid_badish=fopen('./vids_review_badish.txt','wt')
fid_goodish=fopen('./vids_review_goodish.txt','wt')
